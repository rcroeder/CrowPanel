// Code modified by RC Roeder Nove 2024
//
...
//#include <PCA9557.h>                                  // Touch Libraries
#include <TAMC_GT911.h>
#include "ui.h"                                       // your UI from SquareLine
...
LGFX lcd;                                    
#include "touch.h"                      //IMPORTANT: This include needs to be added after the defintition of lcd

//UI
#define TFT_BL 2                        // defines pin for screen brightness 
...
void setup()
{
  ...
  lv_init();                          // Start lvgl instance

  // Init touch device
  touch_init();                       // Start Touch
  ...
  #endif
  //ui_init();  // Uncomment when you add your project
